...
public class ComplexDoubleFFT_Mixed extends ComplexDoubleFFT{
  ...
  void transform_internal( ComplexArray.Double data, int i0, int stride, int sign){
    ...
    ComplexArray.Double scratch = ComplexArray.newArray( new double[n], new double[n] );
    int product = 1;
    int state = 0;
    ComplexArray.Double in, out;
    int istride, ostride;
    int in0, out0;
  ...
  void pass_2(int fi, 
	      ComplexArray.Double in,  int in0, int istride,
	      ComplexArray.Double out, int out0, int ostride,
