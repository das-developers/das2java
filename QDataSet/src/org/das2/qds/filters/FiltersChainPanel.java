...
public final class FiltersChainPanel extends javax.swing.JPanel implements FilterEditorPanel {
    ...
    private FilterEditorPanel getEditorFor(String f, FilterEditorPanel recyclable) {
        ...
        if ( f.matches("\\|add\\((.*)\\)") ) {
        ...
        } else if ( f.matches("\\|fftPowerSpectrum\\((\\d+),(\\d),'?(\\S+)'?\\)") ) {
            result= new FftOutputsFilterEditorPanel();
        ...
        } else if ( f.matches(LttbFilterEditorPanel.PROP_REGEX) ) { 
            result= new LttbFilterEditorPanel();
        ...
        } else if ( f.matches(BinAverage2dFilterEditorPanel.PROP_REGEX) ) {
            result= new BinAverage2dFilterEditorPanel();            
            ...
            result= new NoArgFilterEditorPanel();
        } else if ( f.matches( DiffModFilterEditorPanel.PROP_REGEX ) ) {
            result= new DiffModFilterEditorPanel();
