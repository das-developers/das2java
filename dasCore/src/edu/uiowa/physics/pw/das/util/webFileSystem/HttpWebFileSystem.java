 ...
 * @author  Jeremy
 */
public class HttpWebFileSystem extends WebFileSystem {
    
    final File localRoot;
    final URL root;
    
    /** Creates a new instance of WebFileSystem */
    private HttpWebFileSystem(URL root, File localRoot) {
        try {
    ...
    public static WebFileSystem create( URL root ) throws IOException {
        ...
        local.mkdirs();
        return new HttpWebFileSystem( root, local );
    }
    ...
    public File getFile( String filename ) {
        File f= new WebFile( this, filename );
        if ( f.canRead() ) {
            return f;
        } else {
            try {
