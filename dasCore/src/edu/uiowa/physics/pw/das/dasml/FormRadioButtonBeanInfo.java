/* File: FormRadioButtonBeanInfo.java
 ...
 */
public class FormRadioButtonBeanInfo extends AccessLevelBeanInfo {
    
    private static Property[] properties = {
        new Property("name", AccessLevel.ALL, "getDasName", "setDasName", null),
        new Property("value", AccessLevel.DASML, "getValue", "setValue", null),
    ...
    public FormRadioButtonBeanInfo() {
        super(properties, FormRadioButton.class);
    }
