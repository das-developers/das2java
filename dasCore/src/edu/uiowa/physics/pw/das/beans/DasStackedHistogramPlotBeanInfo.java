 ...
 * @author Edward West
 */
public class DasStackedHistogramPlotBeanInfo extends AccessLevelBeanInfo {
    ...
    public DasStackedHistogramPlotBeanInfo() {
        super(properties, edu.uiowa.physics.pw.das.graph.DasStackedHistogramPlot.class);
    }
