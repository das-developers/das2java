...
public class CrossHairMouseModule extends MouseModule {
	...
	public static abstract class InfoItem {
		public abstract void label(org.das2.datum.Datum x, org.das2.datum.Datum y, StringBuilder out);
		public org.das2.datum.Datum[] snap(org.das2.datum.Datum x, org.das2.datum.Datum y) {
			return null;
		}
	}
	...
	public void addInfoItem(InfoItem i) {
		DragRenderer dr = getDragRenderer();
