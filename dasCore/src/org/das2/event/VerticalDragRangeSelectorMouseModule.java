...
public class VerticalDragRangeSelectorMouseModule extends MouseModule {
    ...
    public VerticalDragRangeSelectorMouseModule(DasPlot parent, org.das2.dataset.DataSetConsumer dataSetConsumer, DasAxis axis) {
        super( parent, new VerticalDragRangeRenderer(parent), "Horizontal Drag Range" );
    ...
    public static VerticalDragRangeSelectorMouseModule create(DasPlot parent) {
        VerticalDragRangeSelectorMouseModule result=
           new VerticalDragRangeSelectorMouseModule(parent,null,parent.getYAxis());
        return result;
    }
